...
bars1 = ax.bar(x - 1.5*width, baseline, width, label="Baseline", color="#4C72B0", edgecolor="white")
bars2 = ax.bar(x - 0.5*width, refine_r3, width, label="Iter. Refinement (r=3, old prompt)", color="#DD8452", edgecolor="white")
bars3 = ax.bar(x + 0.5*width, refine_r12_old, width, label="Iter. Refinement (r=12, old prompt)", color="#55A868", edgecolor="white")
bars4 = ax.bar(x + 1.5*width, refine_r12_new, width, label="Iter. Refinement (r=12, new prompt)", color="#C44E52", edgecolor="white")
